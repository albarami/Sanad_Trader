...
# Pricing (per million tokens) — CORRECTED 2026-02-19
# Anthropic Opus 4.6 (released Feb 4, 2026): $5 input / $25 output
# Anthropic Haiku 4.5: $1 input / $5 output
# Legacy Opus 4/4.1 was $15/$75 — NOT current pricing
PRICING = {
    "claude-opus-4-6": {"input": 5.0, "output": 25.0},  # REVERTED to correct pricing
    "claude-sonnet-4-6": {"input": 3.0, "output": 15.0},
    "claude-haiku-4-5-20251001": {"input": 1.0, "output": 5.0},  # REVERTED to correct pricing
