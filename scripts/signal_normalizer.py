...
def normalize_signal(raw: dict, source_hint: str = "") -> dict | None:
    ...
    normalizers = {
        ...
        "coingecko": lambda r: {
            ...
            "volume_24h_usd": r.get("volume_24h", r.get("total_volume", 0)),
            "price_change_24h_pct": r.get("price_change_24h_pct", r.get("price_change_percentage_24h", 0)),
            "price_change_1h_pct": r.get("price_change_1h_pct", 0),
